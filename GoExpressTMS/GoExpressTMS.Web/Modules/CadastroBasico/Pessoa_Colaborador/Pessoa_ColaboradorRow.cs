...
namespace GoExpressTMS.CadastroBasico.Entities
{
    ...
    [InnerJoin("jColaborador", "Colaborador", "jColaborador.[PessoaId] = T0.[PessoaId]", RowType = typeof(ColaboradorRow), TitlePrefix = "")]
    [UpdatableExtension("jColaborador", typeof(ColaboradorRow), CascadeDelete = true)]
    ...
    [DisplayName("Colaboradores"), InstanceName("Colaborador")]
    [ReadPermission(PermissionKeys.Colaborador.Visualizar)]
    [ModifyPermission(PermissionKeys.Colaborador.Alterar)]
    public sealed class Pessoa_ColaboradorRow : Row, IIdRow, INameRow
    {
        ...
        [LookupEditor(typeof(TipoColaboradorRow), InplaceAdd = true, InplaceAddPermission = Auxiliar.PermissionKeys.TipoColaborador.Alterar)]
        ...
        [DisplayName("Tipo"), Expression("jTipoColaborador.Tipo")]
        public String TipoColaborador
        {
            get { return Fields.TipoColaborador[this]; }
            set { Fields.TipoColaborador[this] = value; }
        }
        ...
        [Origin("jPessoaFisica")]
        [DisplayName("Órgão Emissor"), Column("RG_OrgaoEmissor"), ForeignKey("[dbo].[OrgaoEmissor]", "OrgaoEmissorId"), LeftJoin("jRgOrgaoEmissor"), TextualField("RgOrgaoEmissorNome")]
        ...
        public Pessoa_ColaboradorRow() : base(Fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public StringField TipoColaborador;

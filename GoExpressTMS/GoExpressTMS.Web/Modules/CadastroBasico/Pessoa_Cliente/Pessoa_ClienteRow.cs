...
namespace GoExpressTMS.CadastroBasico.Entities
{
    ...
    [InnerJoin("jCliente", "Cliente", "jCliente.[PessoaId] = T0.[PessoaId]", RowType = typeof(ClienteRow), TitlePrefix = "")]
    [UpdatableExtension("jCliente", typeof(ClienteRow), CascadeDelete = true)]
    ...
    [LeftJoin("jPessoaJuridica", "PessoaJuridica", "jPessoaJuridica.[PessoaId] = T0.[PessoaId]", RowType = typeof(PessoaJuridicaRow), TitlePrefix = "")]
    [UpdatableExtension("jPessoaJuridica", typeof(PessoaJuridicaRow), CascadeDelete = true)]

    [DisplayName("Clientes"), InstanceName("Cliente")]
    [ReadPermission(PermissionKeys.Cliente.Visualizar)]
    [ModifyPermission(PermissionKeys.Cliente.Alterar)]
    public sealed class Pessoa_ClienteRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("Tipo Pessoa"), Size(1), NotNull, TipoPessoaEditor]
        ...
        [DisplayName("Tipo Pessoa"), Expression("CASE T0.TipoPessoa WHEN 'F' THEN 'Pessoa Física' WHEN 'J' THEN 'Pessoa Jurídica' END")]
        public String PessoaTipo
        {
            get { return Fields.PessoaTipo[this]; }
            set { Fields.PessoaTipo[this] = value; }
        }
        ...
        [Origin("jPessoaJuridica")]
        [DisplayName("Razão Social"), Size(128), QuickSearch]
        ...
        [Origin("jPessoaJuridica")]
        [DisplayName("CNPJ"), Column("CNPJ"), Size(20), QuickSearch, MaskedEditor(Mask = "99.999.999/9999-99")]
        public String Cnpj
        {
        ...
        [Origin("jPessoaJuridica")]
        [DisplayName("Insc. Estadual"), Size(30), QuickSearch]
        ...
        [Origin("jPessoaJuridica")]
        [DisplayName("Insc. Municipal"), Size(30), QuickSearch]
        ...
        public Pessoa_ClienteRow() : base(Fields)
        {
        }
